...
```bash
curl -L -o direxio-connect.tar.gz https://github.com/YingSuiAI/direxio-connect/releases/latest/download/direxio-connect-v1.3.13-linux-amd64.tar.gz
tar xzf direxio-connect.tar.gz
chmod +x direxio-connect-v1.3.13-linux-amd64
sudo mv direxio-connect-v1.3.13-linux-amd64 /usr/local/bin/direxio-connect
```
